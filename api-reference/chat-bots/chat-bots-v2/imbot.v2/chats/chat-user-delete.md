...
- JS (TS)
    ...
    type ChatUserDeleteResult = {
      result: boolean
    }

    try {
      const response = await $b24.actions.v2.call.make<ChatUserDeleteResult>({
        method: 'imbot.v2.Chat.User.delete',
        params: {
          botId: 456,
          dialogId: 'chat5',
          userId: 1,
      ...
      if (!response.isSuccess) {
        ...
        console.info('User deleted:', result.result)
      }
    } catch (error) {
