...
- JS (TS)
    ...
    type ChatLeaveResult = {
      result: boolean
    }

    try {
      const response = await $b24.actions.v2.call.make<ChatLeaveResult>({
        method: 'imbot.v2.Chat.leave',
        params: {
          botId: 456,
          dialogId: 'chat5',
        },
      ...
      if (!response.isSuccess) {
        ...
        console.info('Bot left the chat:', result.result)
      }
    } catch (error) {
