...
- JS (TS)
    ...
    type ChatUserAddResult = {
      result: boolean
    }

    try {
      const response = await $b24.actions.v2.call.make<ChatUserAddResult>({
        method: 'imbot.v2.Chat.User.add',
        params: {
          botId: 456,
          dialogId: 'chat5',
          userIds: [1, 2, 3],
      ...
      if (!response.isSuccess) {
        ...
        console.info('Users added:', result.result)
      }
    } catch (error) {
