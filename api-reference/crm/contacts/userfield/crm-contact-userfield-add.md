...
- JS (UMD)
    ...
    <script>
      async function addContactUserfieldString() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', addContactUserfieldString)
    </script>
    ```
...
- JS (UMD)
    ...
    <script src="https://unpkg.com/@bitrix24/b24jssdk@1/dist/umd/index.min.js"></script>
    <script>
      async function addContactUserfieldEnumeration() {
        try {
          // Initialize the SDK inside a Bitrix24 frame
          const $b24 = await B24Js.initializeB24Frame()
      ...
      document.addEventListener('DOMContentLoaded', addContactUserfieldEnumeration)
    </script>
    ```
